    ...
    return (
        <div className='pt-6'>
           <PageTitle title='Pesquisa'/>
            ...
            { sucess && <div className='w-1/5 mx-auto'>
                <p className='mb-6 text-center bg-blue-100 border-t border-b border-blue-500 text-blue-700 px-4 py-3'>Obrigado por contribuir com sua opinião ou crítica!</p>
                {
                    retorno.showCupom && 
                    <div className='text-center border p-4 mb-4'>
                        Seu cupom: <br />
                        <span className='font-bold ext-2xl'>{retorno.Cupom}</span>
                    </div>
                }
                 {
                    retorno.showCupom && 
